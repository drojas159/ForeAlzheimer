<%-- 
    ...
    Created on : 9/05/2020, 5:17:34 p. m.
    Author     : Daniela
--%>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form name="register_form" method="post"
                                      action="UserController?action=EditInfo">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="inputNumDoc" type="number" 
                                                       value="<%=usr.getNum_documento()%>" placeholder="Número de Documento"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="inputNames" type="text"  
                                               value="<%=usr.getNombres()%>" placeholder="Nombres" required/>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" name="inputFirstLastName" type="text" 
                                                       value="<%=usr.getApellido1()%>" placeholder="Ingrese su primer apellido" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" name="inputSecondLastName" type="text" 
                                                       value="<%=usr.getApellido2()%>" placeholder="Ingrese su segundo apellido"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">                                                
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="inputCel" type="number" 
                                                       value="<%=usr.getCelular()%>" placeholder="Número de Celular" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="inputTel" type="number" 
                                                       value="<%=usr.getTel_fijo()%>"placeholder="Número de Teléfono Fijo"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="inputEmail" type="email" aria-describedby="emailHelp" 
                                                       value="<%=usr.getEmail().toLowerCase()%>" placeholder="Correo electrónico institucional" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
