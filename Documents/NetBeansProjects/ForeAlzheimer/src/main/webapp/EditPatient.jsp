                        ...
                        <div class="jumbotron">
                            ...
                            <form name="form" method="post" action="UserController?action=EditPatient">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputPassword">Número de documento del paciente:</label>
                                    <input class="form-control py-4" name="inputDoc" type="number" placeholder="Número de Documento" required />
                                </div>
