                                    ...
                                    <div class="card shadow-sm border rounded-lg mt-5">
                                        ...
                                        <div class="card-body">
                                            <div class="small mb-3 text-muted">
                                                Ingrese su contraseña para editar datos personales.
                                            </div>
                                            <form name="login_form" method="post" action="UserController?action=PreEdit">
                                                <div class="form-group">
                                                    <label class="small mb-1" for="inputPassword">Contraseña:</label>
                                                    <input class="form-control py-4" name="inputPassword" type="password" placeholder="Contraseña" required />
                                                </div>
