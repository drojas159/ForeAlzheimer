                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="jumbotron">
                            ...
                            <h3 class="font-weight-light">Editar Datos del Usuario</h3>
                            <br>


                            <form name="form" method="post" action="UserController?action=EditUsr">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputPassword">Número de documento del usuario:</label>
                                    <input class="form-control py-4" name="inputDoc" type="number" placeholder="Número de Documento" 
