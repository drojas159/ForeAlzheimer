            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="jumbotron">
                            <center>
                                <h1>COVID-19 BOGOTÁ</h1>
                                <br>

                                <p>GISIC también se ha preocupado por generar conocimiento a través del análisis de datos. 
                                    Por eso, el Grupo de Investigación se dio a la tarea de realizar un análisis de la actual crisis que enfrenta el planeta
                                 generada por el COVID-19.
                                 <br><br>
                                 Para más información, ingrese al siguiente link. 
                                 <br><br>
                                 <a href="https://public.tableau.com/profile/itperforma#!/vizhome/COVID19-BOGOTA/Covid19-itP?publish=yes"> 
                                     COVID-19 BOGOTÁ
                                 </a>
                                </p>
