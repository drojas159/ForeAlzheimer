...
<%    
    ...
    String Rol[] = {"AUXILIAR", "PSICOLOGO"};

    List<Usuario> usuarios = controller.consultarPacientes(Rol);
%>
<html lang="es">
    <head>
        <meta charset="utf-8" />
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePerfil" aria-labelledby="headingOne"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <%
                                                        ...
                                                        if (usuario.getRol1() != null) {
                                                            rol1 = "<i class='fas fa-check'></i>";
                                                        }
                                                        if (usuario.getRol2() != null) {
                                                            rol2 = "<i class='fas fa-check'></i>";
                                                        }

                                                    %>
                                                    <td>
                                                        <form name="form" method="post"
                                                              action="UserController?action=DeleteUsr">
                                                            <input style='display:none;' name='inputId' value='<%= usuario.getNum_documento()%>'>
                                                            <button class="btn btn-danger">
                                                                <i class="fas fa-user-minus"></i>
                                                            </button>
                                                        </form></td>    
                                                    <td><%= usuario.getTipo_documento()%></td>
                                                    <td><%= usuario.getNum_documento()%></td>
                                                    <td><%= usuario.getNombres()%></td>
                                                    <td><%= usuario.getApellido1()%></td>
                                                    <td><%= usuario.getApellido2()%></td>
                                                    <td><%= usuario.getTel_fijo()%></td>
                                                    <td><%= usuario.getCelular()%></td>
                                                    <td><%= usuario.getEmail().toLowerCase()%></td>
                                                    <td><%= rol1%></td>
                                                    <td><%= rol2%></td>
                                                </tr>
                                                <%
