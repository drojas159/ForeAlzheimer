                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="jumbotron">
                            ...
                            <h3 class="font-weight-light">Cambiar Contraseña</h3>
                            <br>


                            <form name="form" method="post" action="UserController?action=EditPassword">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputPassword">Contraseña antigua:</label>
                                    <input class="form-control py-4" name="inputOld" type="password" placeholder="Ingrese su contraseña antigua" required />
                                </div>
                                <div class="form-group">
                                    <label class="small mb-1" for="inputPassword">Contraseña nueva:</label>
                                    <input class="form-control py-4" name="inputNew" type="password" placeholder="Ingrese su contraseña nueva" required />
                                </div>
